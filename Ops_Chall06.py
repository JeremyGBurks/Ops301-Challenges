...
ipadd = subprocess.check_output("ip a")
hardware = subprocess.check_output("lshw -short")
computername = socket.gethostname()

print(username + " is the user on " + computername)
print(ipadd + " is the IP info of " + computername)
print(hardware + " is the hardware info for " + computername)
